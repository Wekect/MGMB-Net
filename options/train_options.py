...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--g_lr_ratio', type=float, default=1.0, help='a ratio for changing learning rate of generator') #mia
        parser.add_argument('--d_lr_ratio', type=float, default=1.0, help='a ratio for changing learning rate of discriminator') #mia
